...
def generate_fake_images(run_id, snapshot=None, grid_size=[1,1], num_pngs=1, image_shrink=1, png_prefix=None, random_seed=1000, minibatch_size=8):
    ...
    for png_idx in range(num_pngs):
        ...
        misc.save_image_grid(images, os.path.join(result_subdir, '%s%06d_26_04.png' % (png_prefix, png_idx)), [0,255], grid_size)
    open(os.path.join(result_subdir, '26_04_done.txt'), 'wt').close()
